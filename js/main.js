...
// Assuming you have a container for the contact section
const contactContainer = document.getElementById('contactContainer');

// Create a Google Maps div and append it to the contact container
const googleMaps = document.createElement('div'); 
googleMaps.setAttribute('id', 'map');   
googleMaps.style.width = '100%'; // Set width to 100%
googleMaps.style.height = '400px'; // Set height to 400px (or whatever height you prefer)
